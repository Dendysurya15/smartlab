                    ...
                    <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(1), ['dashboard'])){{ 'hover:text-slate-200' }}@endif" href="{{route('dashboard')}}">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="shrink-0 h-6 w-6" height="1em" viewBox="0 0 512 512">
                                ...
                                <path class="fill-current @if(in_array(Request::segment(1), ['dashboard'])){{ 'text-emerald-300' }}@else{{ 'text-slate-400' }}@endif" d="M0 96C0 60.7 28.7 32 64 32H448c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96zm64 64V416H224V160H64zm384 0H288V416H448V160z" />
                            ...
                            <ul class="pl-9 mt-1 @if(!in_array(Request::segment(1), ['system.index', 'roles'])){{ 'hidden' }}@endif" :class="open ? '!block' : 'hidden'">
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if(Route::is('roles')){{ '!text-emerald-500' }}@endif" href="{{route('roles')}}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Roles Management</span>
                                    </a>
                                </li>
                                @endcan
                            </ul>
