<div>
    <form wire:submit.prevent="save" method="POST" enctype="multipart/form-data">
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button type="submit" @if($isDisabled) disabled @endif class="rounded-md @if($isDisabled) bg-grey-400 @else bg-emerald-600 @endif px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-emerald-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600">Simpan Parameter
