            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-2">
                            <input type="datetime-local" wire:model="tanggal_memo" id="tanggal_memo"
                    ...
                    <div class="sm:col-span-2">
                        <label for="jumlah_sampel" class="block text-sm font-medium leading-6 text-gray-900">Jumlah
                            Sampel <span style="color:red">*</span></label>
                        <div class="mt-2">
                            <input type="number" wire:model="jumlah_sampel" wire:change="getlabstatus"
                                autocomplete="given-name" value="{{ old('jumlah_sampel') }}"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6">
                ...
                <div class="mt-6 flex items-center justify-end gap-x-2">
                    ...
                    <button type="button" wire:click="draftKupa" wire:loading.attr="disabled"
                        wire:loading.class="opacity-50"
                    ...
                    <button type="submit" wire:click="save" wire:loading.attr="disabled" wire:loading.class="opacity-50"
