            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div class="col-span-1 md:col-span-1">
                    <label for="no_kupa" class="block text-sm font-medium leading-6 text-gray-900">Nomor
                        Kupa</label>
                    <div class="mt-2">
                        <input type="number" name="no_kupa" id="no_kupa" wire:model="no_kupa" autocomplete="given-name"
                            value=""
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6">
            ...
            <div class="sm:col-span-6  rounded-lg border border-dashed border-gray-900/25 mt-8">
                ...
                <div class="grid grid-cols-5 gap-5 mt-4">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <div class="mt-2">
                                <div class="flex h-6 items-center">
                                    <input id="personel" wire:model.defer="oldform.{{ $index }}.personel"
                                        type="checkbox"
                            ...
                            <div class="mt-2">
                                ...
                                <div class="flex h-6 items-center">
                                    <input id="alat" wire:model.defer="oldform.{{ $index }}.alat" type="checkbox"
                                        class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                </div>
                                <div class="text-sm leading-6">
                            ...
                            <div class="mt-2">
                                <div class="flex h-6 items-center">
                                    <input id="bahan" wire:model.defer="oldform.{{ $index }}.bahan" type="checkbox"
                                        class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                </div>
                                <div class="text-sm leading-6">
                    ...
                    {{-- <div class="sm:col-span-1">
                        ...
                        <div class="mt-2">
                            <input type="text" wire:model.defer="oldform.{{ $index }}.ppn"
                                wire:change="ppnold({{ $index }})" placeholder="Parameter jumlah"
                                class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6">
                        </div>
