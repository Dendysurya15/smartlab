            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-5 gap-5 mb-2 p-2 border border-dashed border-gray-900/25 rounded-lg">
                            <div class="sm:col-span-2">
                                <label class="block text-sm font-medium leading-6 text-gray-900">{{$parameter['nama_parameters']}}</label>
                                <div class="mt-2 ml-4 text-sm">{{ $parameter['metode_analisis'] }}</div>
                            </div>
                            ...
                            <div class="sm:col-span-1 mt-2 sm:mt-0">
