<form wire:submit.prevent="save" method="POST" enctype="multipart/form-data" wire:loading.class="opacity-50">
    ...
    <div class="sm:col-span-6  rounded-lg border border-dashed border-gray-900/25 mt-8">
        ...
        <div class="grid grid-cols-5 gap-5 mt-4">
            ...
            <div class="sm:col-span-1">
                ...
                <div class="mt-2">
                    <input type="text" wire:model.defer="oldform.{{ $index }}.jumlah" wire:change="totalsampelold({{ $index }})" placeholder="Parameter jumlah" class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6">
                </div>
                ...
                <div class="mt-2">
                    <input type="text" wire:model.defer="oldform.{{ $index }}.subtotal" placeholder="Parameter jumlah" disabled class="block w-full rounded-md border-0 text-slate-400 font-semibold shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6">
                </div>
            ...
            <div class="sm:col-span-1">
                ...
                <div class="mt-2">
                    <input type="text" wire:change="updateHargaSampel()" wire:model.defer="oldform.{{ $index }}.harga" placeholder="Parameter jumlah" class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6">
                </div>
            ...
            <div class="sm:col-span-1">
                ...
                <div class="mt-2 ">
                    <input type="text" wire:model.defer="oldform.{{ $index }}.harga_total" placeholder="Parameter jumlah" disabled class="block w-full rounded-md border-0 text-slate-400 font-semibold shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6">
                </div>
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6">
        ...
        <button type="submit" wire:loading.remove class="rounded-md bg-emerald-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600">
            Update Progress
        </button>
        <button type="button" wire:loading class="rounded-md bg-emerald-600 px-3 py-2 text-sm font-semibold text-white shadow-sm cursor-not-allowed">

            Update Progress
            <svg aria-hidden="true" id="loading" class="ml-3 inline w-5 h-5 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
