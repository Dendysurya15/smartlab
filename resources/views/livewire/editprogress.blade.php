            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div class="col-span-1 md:col-span-1">
                    ...
                    <div class="mt-2">
                        ...
                        <select id="status_pengerjaan" wire:model="selected_status" autocomplete="status_pengerjaan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-emerald-600  sm:text-sm sm:leading-6">
                            <option value="Approved" @if (old('status_pengerjaan', $status_pengerjaan)==='Approved' ) selected @endif>Approved</option>
                            <option value="Rejected" @if (old('status_pengerjaan', $status_pengerjaan)==='Rejected' ) selected @endif>Rejected</option>
                            <option value="Pending" @if (old('status_pengerjaan', $status_pengerjaan)==='Pending' ) selected @endif>Pending</option>
                        </select>
                        @else
                        <select id="status_pengerjaan" wire:model="selected_status" autocomplete="status_pengerjaan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-emerald-600  sm:text-sm sm:leading-6" disabled>
                            <option value="Approved" @if (old('status_pengerjaan', $status_pengerjaan)==='Approved' ) selected @endif>Approved</option>
                            <option value="Rejected" @if (old('status_pengerjaan', $status_pengerjaan)==='Rejected' ) selected @endif>Rejected</option>
                            <option value="Pending" @if (old('status_pengerjaan', $status_pengerjaan)==='Pending' ) selected @endif>Pending</option>
                        </select>
                ...
                <div class="col-span-1 md:col-span-1">
                    ...
                    <div class="mt-2">
                        <select wire:model="get_progress" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-emerald-600  sm:text-sm sm:leading-6">
            ...
            <div class="sm:col-span-6 mt-5 rounded-lg border border-dashed border-gray-900/25">
                ...
                <div class="grid grid-cols-5 gap-5 mt-4">
                    ...
                    {{-- <label class="block text-sm font-medium leading-6 text-gray-900"> Subtotal</label>
                        ...
                        <div class="mt-2">
                            <input type="text" wire:model.defer="oldform.{{ $index }}.subtotal"
            ...
            {{-- <div class="sm:col-span-1">
                        ...
                        <div class="mt-2">
                            <input type="text" wire:change="updateHargaSampel()"
                                wire:model.defer="oldform.{{ $index }}.harga" placeholder="Parameter jumlah"
            class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6">
    </div>
    <label class="block text-sm font-medium leading-6 text-gray-900"> {{
                            $oldform[$index]['judulppn']
                            }}</label>

    <div class="mt-2">
        <input type="text" wire:model.defer="oldform.{{ $index }}.ppn" wire:change="ppnold({{ $index }})" placeholder="Parameter jumlah" class="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-emerald-600 sm:text-sm sm:leading-6">
    </div>
...
<div class="sm:col-span-1">
    ...
    <div class="mt-2">
        <button class="rounded-md bg-red-400 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600" wire:click.prevent="hapusItem({{ $index }})">
            Hapus Parameter
        </button>
    </div>
</div>
...
<div class="mt-6 flex items-center gap-x-6">
    <button wire:click="exportExcel" class="rounded-md bg-emerald-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600">Export
        Excel</button>
</div>
--}}
