            ...
            <div class="w-full md:w-1/2">
                ...
                <div class="min-h-screen h-full flex flex-col after:flex-1">
                    ...
                    <div class="w-full max-w-sm mx-auto px-4 py-8">
                        ...
                        <h1 class="italic mb-4">Progress sampel anda:
                            ...
                            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <ul class="space-y-4 text-left text-gray-500 dark:text-gray-400">
                                    <li class="flex items-start space-x-3">
                                        <svg class="mt-1 w-4.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                                        </svg>
                                        <div>
                                            @foreach ($progres as $items)
                                            <p class="mb-3" id="caption">{{$items}}</p>
                                            @endforeach
                                            @foreach ($jamprogres as $items)
                                            <p class="mb-3 text-sm" id="tgl_update">{{$items}}</p>
                                            @endforeach
                                        </div>
                                    </li>
                                </ul>
