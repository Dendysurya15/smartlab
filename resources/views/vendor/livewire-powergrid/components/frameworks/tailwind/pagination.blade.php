    ...
    <div class="items-center justify-between w-full sm:flex-1 sm:flex">
        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="items-center justify-between sm:flex">
            <div class="flex justify-center mt-2 md:flex-none md:justify-end sm:mt-0">
                ...
                <a class="px-2 py-1 pt-2 m-1 text-center text-white bg-slate-600 border-pg-primary-400 rounded cursor-pointer border-1 hover:bg-pg-primary-600 hover:border-pg-primary-800 dark:text-pg-primary-300"
                ...
                <span
                    class="px-2 py-1 m-1 text-center text-white hover:bg-slate-800 bg-slate-600 border-pg-primary-400 rounded cursor-pointer border-1 dark:bg-slate-600 dark:text-white dark:text-pg-primary-300">{{
                    $page }}</span>
                @elseif (
                ...
                $page === $paginator->currentPage() - 1 ||
                $page === $paginator->currentPage() - 2)
                <a class="px-2 py-1 m-1 text-center text-black hover:bg-slate-200 bg-pg-primary-500 border-pg-primary-400 rounded cursor-pointer border-1 hover:bg-pg-primary-600 hover:border-pg-primary-800 dark:text-pg-primary-300"
